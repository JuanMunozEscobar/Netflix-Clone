    ...
    const handleSearch = async (e) => {
        ...
        try {
            ...
            if (error.response.status === 404) {
                toast.error("Nothing found, make sure you are searching in the correct category");
            } else {
    ...
    return (
        <div className="bg-black min-h-screen text-white">
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <form className="flex gap-2 items-stretch mb-8 max-x-2xl mx-auto" onSubmit={handleSearch}>
                    <input
                        type="text"
                        value={searchTerm}
